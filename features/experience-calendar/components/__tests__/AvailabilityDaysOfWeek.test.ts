...
import AvailabilityDaysOfWeek, { Props } from "../AvailabilityDaysOfWeek.vue";
...
describe("AvailabilityDaysOfWeek", () => {
  beforeEach(() => {
    vi.useFakeTimers();
  });
  afterEach(() => {
  ...
  test("it should render correctly", () => {
    const wrapper = mount(AvailabilityDaysOfWeek, { props });
  ...
  describe("when one of the days is deselected", () => {
    test("it should remove the schedule day card", async () => {
      ...
      const wrapper = mount(AvailabilityDaysOfWeek, { props: newProps });
  ...
  describe("when the user clicks on 'copy settings'", () => {
    ...
    test("it should update the other day cards", async () => {
      const wrapper = mount(AvailabilityDaysOfWeek, {
        props: {
          ...props,
          availability,
        },
